	...
	testArchives = []struct {
	...
	}{
		{
			...
			headers: []tar.Header{
				...
				{Name: "link-0", Typeflag: tar.TypeSymlink, Linkname: filepath.Join("..", "file-0"), Size: 123456789, Mode: 0o777, ModTime: testDate},
				{Name: "link-a", Typeflag: tar.TypeSymlink, Linkname: "file-a", Size: 23, Mode: 0o777, ModTime: testDate},
				{Name: "link-b", Typeflag: tar.TypeSymlink, Linkname: filepath.Join("..", "file-a"), Size: 23, Mode: 0o777, ModTime: testDate},
				{Name: "hlink-0", Typeflag: tar.TypeLink, Linkname: "file-0", Size: 123456789, Mode: 0o600, ModTime: testDate},
				{Name: "hlink-a", Typeflag: tar.TypeLink, Linkname: filepath.Join("", "file-a"), Size: 23, Mode: 0o600, ModTime: testDate},
				{Name: "hlink-b", Typeflag: tar.TypeLink, Linkname: filepath.Join("..", "file-b"), Size: 23, Mode: 0o600, ModTime: testDate},
				{Name: "subdir-a", Typeflag: tar.TypeDir, Mode: 0o700, ModTime: testDate},
				{Name: filepath.Join("subdir-a", "file-n"), Typeflag: tar.TypeReg, Size: 108, Mode: 0o660, ModTime: testDate},
				{Name: filepath.Join("subdir-a", "file-o"), Typeflag: tar.TypeReg, Size: 34, Mode: 0o660, ModTime: testDate},
				{Name: filepath.Join("subdir-a", "file-a"), Typeflag: tar.TypeSymlink, Linkname: filepath.Join("..", "file-a"), Size: 23, Mode: 0o777, ModTime: testDate},
				{Name: filepath.Join("subdir-a", "file-b"), Typeflag: tar.TypeSymlink, Linkname: filepath.Join("..", "../file-b"), Size: 23, Mode: 0o777, ModTime: testDate},
				{Name: filepath.Join("subdir-a", "file-c"), Typeflag: tar.TypeSymlink, Linkname: filepath.Join("", "file-c"), Size: 23, Mode: 0o777, ModTime: testDate},
				{Name: "subdir-b", Typeflag: tar.TypeDir, Mode: 0o700, ModTime: testDate},
				{Name: filepath.Join("subdir-b", "file-n"), Typeflag: tar.TypeReg, Size: 216, Mode: 0o660, ModTime: testDate},
				{Name: filepath.Join("subdir-b", "file-o"), Typeflag: tar.TypeReg, Size: 45, Mode: 0o660, ModTime: testDate},
				{Name: "subdir-c", Typeflag: tar.TypeDir, Mode: 0o700, ModTime: testDate},
				{Name: filepath.Join("subdir-c", "file-n"), Typeflag: tar.TypeReg, Size: 432, Mode: 0o666, ModTime: testDate},
				{Name: filepath.Join("subdir-c", "file-o"), Typeflag: tar.TypeReg, Size: 56, Mode: 0o666, ModTime: testDate},
				{Name: "subdir-d", Typeflag: tar.TypeDir, Mode: 0o700, ModTime: testDate},
				{Name: filepath.Join("subdir-d", "hlink-0"), Typeflag: tar.TypeLink, Linkname: filepath.Join("..", "file-0"), Size: 123456789, Mode: 0o600, ModTime: testDate},
				{Name: filepath.Join("subdir-d", "hlink-a"), Typeflag: tar.TypeLink, Linkname: string(os.PathSeparator) + "file-a", Size: 23, Mode: 0o600, ModTime: testDate},
				{Name: filepath.Join("subdir-d", "hlink-b"), Typeflag: tar.TypeLink, Linkname: filepath.Join("..", "..", "file-b"), Size: 23, Mode: 0o600, ModTime: testDate},
				...
				{Name: filepath.Join("subdir-e", "file-p"), Typeflag: tar.TypeReg, Size: 890, Mode: 0o600, ModTime: testDate},
			},
			contents: map[string][]byte{
			...
			expectedGetErrors: []expectedError{
				...
				{inSubdir: false, name: filepath.Join("subdir-a", "file-b"), err: syscall.ENOENT},
				{inSubdir: true, name: "link-0", err: syscall.ENOENT},
				{inSubdir: true, name: "link-b", err: syscall.ENOENT},
				{inSubdir: true, name: filepath.Join("subdir-a", "file-b"), err: syscall.ENOENT},
				{inSubdir: true, name: filepath.Join("subdir-a", "file-c"), err: syscall.ENOENT},
			},
			renames: []struct {
				name     string
				renames  map[string]string
			...
			}{
				{
					...
					expected: []string{
						...
						"hlink-b",
						"subdir-a",
						filepath.Join("subdir-a", "file-n"),
						filepath.Join("subdir-a", "file-o"),
						filepath.Join("subdir-a", "file-a"),
						filepath.Join("subdir-a", "file-b"),
						filepath.Join("subdir-a", "file-c"),
						"subdir-b",
						filepath.Join("subdir-b", "file-n"),
						filepath.Join("subdir-b", "file-o"),
						"subdir-c",
						filepath.Join("subdir-c", "file-n"),
						filepath.Join("subdir-c", "file-o"),
						"subdir-d",
						filepath.Join("subdir-d", "hlink-0"),
						filepath.Join("subdir-d", "hlink-a"),
						filepath.Join("subdir-d", "hlink-b"),
						"subdir-e",
						filepath.Join("subdir-e", "file-p"),
						"archive-a",
					},
				},
				{
				...
				},
				{
					...
					expected: []string{
						...
						"hlink-b",
						"subdir-z",
						filepath.Join("subdir-z", "file-n"),
						filepath.Join("subdir-z", "file-o"),
						filepath.Join("subdir-z", "file-a"),
						filepath.Join("subdir-z", "file-b"),
						filepath.Join("subdir-z", "file-c"),
						"subdir-b",
						filepath.Join("subdir-b", "file-n"),
						filepath.Join("subdir-b", "file-o"),
						"subdir-c",
				...
				},
				{
					...
					renames: map[string]string{filepath.Join("subdir-a", "file-n"): filepath.Join("subdir-a", "file-z")},
					expected: []string{
						"file-0",
						"file-a",
						"file-b",
...
func TestConvertToRelSubdirectory(t *testing.T) {
	// Using a temp dir here as it will c
	tmpdir := t.TempDir()
	depth1 := filepath.Join(tmpdir, "a")
	depth2 := filepath.Join(depth1, "b")
	converted, err := convertToRelSubdirectory(tmpdir, depth1)
	require.NoError(t, err)
	require.Equal(t, "a", converted)
	converted, err = convertToRelSubdirectory(tmpdir, depth2)
	require.NoError(t, err)
	require.Equal(t, "a"+string(os.PathSeparator)+"b", converted)
	converted, err = convertToRelSubdirectory(tmpdir, tmpdir)
	require.NoError(t, err)
	require.Equal(t, ".", converted)

	split := strings.Split(tmpdir, string(os.PathSeparator))
	root := ""
	if split[0] != "" && split[0] == filepath.VolumeName(tmpdir) {
		root = split[0] + string(os.PathSeparator)
	} else {
		root = string(os.PathSeparator)
	}

	converted, err = convertToRelSubdirectory(root, tmpdir)
	require.NoError(t, err)
}
